...
//---  Getter Methods   -----------------------------------------------------------------------
	...
	public Boolean getEventObservability(String ref) {
		return events.get(ref) == null ? null : events.get(ref).getEventObservability();
	}

	public Boolean getEventControllability(String ref) {
		return events.get(ref) == null ? null : events.get(ref).getEventControllability();
	}

	public Boolean getEventAttackerObservability(String ref) {
		return events.get(ref) == null ? null : events.get(ref).getEventAttackerObservability();
	}

//---  Setter Methods   -----------------------------------------------------------------------
	
	public void setEventControllability(String ref, boolean set) {
		if(events.get(ref) != null)
			events.get(ref).setEventControllability(set);
	}
	
	public void setEventObservability(String ref, boolean set) {
		if(events.get(ref) != null)
			events.get(ref).setEventObservability(set);
	}

	public void setEventAttackerObservability(String ref, boolean set) {
		if(events.get(ref) != null)
			events.get(ref).setEventAttackerObservability(set);
	}
...
//---  Manipulations   ------------------------------------------------------------------------
	...
	public Event addEvent(Event event1, Event event2) {
		...
		if(events.containsKey(eventName))
			return events.get(eventName);
		Event newEvent = new Event(event1.getEventName());
		newEvent.setEventControllability(event1.getEventControllability() && event2.getEventControllability());
		newEvent.setEventObservability(event1.getEventObservability() && event2.getEventObservability());
		events.put(eventName, newEvent);
		return newEvent;
	}
