...
//---  Operations   ---------------------------------------------------------------------------
	...
	public State copy() {
		State out = new State(getStateName());
		out.setStateBad(getStateBad());
		out.setStateInitial(getStateInitial());
		out.setStateMarked(getStateMarked());
		out.setStatePrivate(getStatePrivate());
		return out;
	}
