...
//---  Constants   ----------------------------------------------------------------------------
	...
	public final static String[] EVENT_LIST_A = new String[] {"a1", "a2", "b1", "b2", "c"};
	
	public final static String[] EVENT_LIST_B = new String[] {"a", "b", "c", "d", "s"};
	
	public final static String[] EVENT_LIST_C = new String[] {"a1", "a2", "b1", "b2", "c", "d"};
	
	public final static String[] EVENT_LIST_D = new String[] {"a", "b", "c"};
	
	public final static String[] EVENT_LIST_E = new String[] {"a1", "a2", "b1", "b2", "c1", "c2", "c3", "d", "s"};
