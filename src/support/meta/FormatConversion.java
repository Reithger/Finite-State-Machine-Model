...
//---  Operations   ---------------------------------------------------------------------------
	...
	public static String createImgFromFSM(TransitionSystem fsm, String name){
		if(initializeCheck()) {
	...
	public static String createSVGFromFSM(TransitionSystem fsm, String name){
		if(initializeCheck()) {
	...
	public static String createTikZFromSVG(TransitionSystem fsm, String name) {
		if(initializeCheck()) {
	...
	public static String createTikZFromFSM(TransitionSystem fsm, String name) {
		if(initializeCheck()) {
...
//---  Support Functions   --------------------------------------------------------------------
	...
	public static File generateDotFile(TransitionSystem fsm, String name, String type) {
